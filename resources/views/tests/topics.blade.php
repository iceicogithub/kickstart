        ...
        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
            <div class="card shadow mb-3">
                <div class="card-body">
                    <form>
                        <div class="mb-3">
                             <input class="form-control me-2" type="search" placeholder=" Filter" aria-label="Search" class="filter">
                        </div>
                    </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-4 col-sm-12">
                            ...
                            <div class="card-style-list">
                                <div class="tests">
                                    <ul>
                                        <li><a href="{{route('tests.question&answer')}}" class="nav-link">Problems on Trains</a></li>
                                        <li><a href="" class="nav-link">Height and Distance</a></li>
                                        <li><a href="" class="nav-link">Simple Interest</a></li>
                                        <li><a href="" class="nav-link">Logical</a></li>
                                        <li><a href="" class="nav-link">Problems on Trains</a></li>
                                        <li><a href="" class="nav-link">Height and Distance</a></li>
                                        <li><a href="" class="nav-link">Simple Interest</a></li>
                                        <li><a href="" class="nav-link">Logical</a></li>
                                    </ul>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-4 col-sm-12">
                            ...
                            <div class="card-style-list">
                                <div class="tests">
                                    <ul>
                                        <li><a href="" class="nav-link">Stocks and Shares</a></li>
                                        <li><a href="" class="nav-link">Time and Distance</a></li>
                                        <li><a href="" class="nav-link">Time and Work</a></li>
                                        <li><a href="" class="nav-link">Problems on Ages</a></li>
                                        <li><a href="" class="nav-link">Stocks and Shares</a></li>
                                        <li><a href="" class="nav-link">Time and Distance</a></li>
                                        <li><a href="" class="nav-link">Time and Work</a></li>
                                        <li><a href="" class="nav-link">Problems on Ages</a></li>
