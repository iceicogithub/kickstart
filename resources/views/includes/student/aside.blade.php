<nav class="sidebar vertical-scroll ps-container ps-theme-default ps-active-y">
    <div class="logo d-flex justify-content-between">
        <a href="index.html"><img src="{{asset('studentdashboard/img/logo.png')}}" alt /></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class>
            <a href="invoice.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/6.svg')}}" alt />
                </div>
                <span>Invoice</span>
            </a>
        </li>
        <li class>
            <a href="calender.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/7.svg')}}" alt />
                </div>
                <span>Calander</span>
            </a>
        </li>
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/8.svg')}}" alt />
                </div>
                <span>Products</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/9.svg')}}" alt />
                </div>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/10.svg')}}" alt />
                </div>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/11.svg')}}" alt />
                </div>
                <span>Table</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/12.svg')}}" alt />
                </div>
                <span>Cards</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/14.svg')}}" alt />
                </div>
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/15.svg')}}" alt />
                </div>
                <span>Maps</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('studentdashboard/img/menu-icon/16.svg')}}" alt />
                </div>
                <span>Pages</span>
            </a>
            <ul>
